...
<div class="adace-popup adace-popup-detector">
	<div class="adace-popup-inner">
		...
		<h2 class="adace-detector-title"><?php echo esc_html( $title );?></h2>
		...
		<p class="adace-detector-buttons">
			...
			?>
				<a href="<?php echo esc_url( $page_url );?>" class="adace-detector-button-disable"><?php echo esc_html__( 'How to disable?', 'adace' );?></a>
			<?php endif;?>
			<a  class="adace-detector-button-refresh"><?php echo esc_html__( 'Refresh', 'adace' );?></a>
		</p>
	</div>
