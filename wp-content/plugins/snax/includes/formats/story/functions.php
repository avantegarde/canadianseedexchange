 ...
 * @return string
 */
function snax_text_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_text_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_text_singular_name', $val );
}
 ...
 * @return string
 */
function snax_text_get_add_new( $default = '' ) {
	$val = get_option( 'snax_text_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_text_add_new', $val );
}
 ...
 * @return string
 */
function snax_text_get_description( $default = '' ) {
	$val = get_option( 'snax_text_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_text_description', $val );
}
 ...
 * @return string
 */
function snax_text_get_overview( $default = '' ) {
	$val = get_option( 'snax_text_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_text_overview', $val );
}
