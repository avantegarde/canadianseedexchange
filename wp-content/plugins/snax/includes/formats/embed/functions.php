 ...
 * @return string
 */
function snax_embed_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_embed_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_embed_singular_name', $val );
}
 ...
 * @return string
 */
function snax_embed_get_add_new( $default = '' ) {
	$val = get_option( 'snax_embed_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_embed_add_new', $val );
}
 ...
 * @return string
 */
function snax_embed_get_description( $default = '' ) {
	$val = get_option( 'snax_embed_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_embed_description', $val );
}
 ...
 * @return string
 */
function snax_embed_get_overview( $default = '' ) {
	$val = get_option( 'snax_embed_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_embed_overview', $val );
}
