...
function snax_create_video( $data ) {
	...
	foreach ( $orphans as $orphan ) {
		...
		$featured_image_id = get_post_thumbnail_id( $orphan );
	...
	// If the Featured Image field is on and user uploaded an image, use it and override current image (if set).
	if ( ! snax_is_featured_media_field_disabled( 'video' ) ) {
 ...
 * @return string
 */
function snax_video_featured_media_field() {
	$default = snax_get_legacy_featured_media_required_setting();

	return apply_filters( 'snax_video_featured_media_field', get_option( 'snax_video_featured_media_field', $default ) );
}

/**
 * Return possible video adding methods
 *
 * @param string $default       Optional. Default value.
 *
 * @return string
 */
function snax_video_get_adding_method( $default = 'upload_embed' ) {
	return apply_filters( 'snax_video_adding_method', get_option( 'snax_video_adding_method', $default ) );
}
 ...
 * @return bool
 */
function snax_video_show_featured_media() {
	$default = snax_get_legacy_show_featured_media_setting( 'video' );

	return 'standard' === apply_filters( 'snax_video_show_featured_media', get_option( 'snax_video_show_featured_media', $default ) );
}
 ...
 * @return bool
 */
function snax_video_show_featured_media_field() {
	return 'disabled' !== snax_video_featured_media_field();
}
 ...
 * @return string
 */
function snax_video_category_field() {
	$default = snax_get_legacy_category_required_setting();

	return apply_filters( 'snax_video_category_field', get_option( 'snax_video_category_field', $default ) );
}
 ...
 * @return bool
 */
function snax_video_show_category_field() {
	return 'disabled' !== snax_video_category_field();
}
 ...
 * @return bool
 */
function snax_video_multiple_categories_selection() {
	$default = snax_get_legacy_category_multi_setting();

	return 'standard' === apply_filters( 'snax_video_category_multi', get_option( 'snax_video_category_multi', $default ) );
}
 ...
 * @return array
 */
function snax_video_get_category_whitelist() {
	$default = snax_get_legacy_category_whitelist_setting();

	return apply_filters( 'snax_video_category_whitelist', get_option( 'snax_video_category_whitelist', $default ) );
}
 ...
 * @return array
 */
function snax_video_get_category_auto_assign() {
	$default = snax_get_legacy_category_auto_assign_setting();

	return apply_filters( 'snax_video_category_auto_assign', get_option( 'snax_video_category_auto_assign', $default ) );
}
 ...
 * @return string
 */
function snax_video_allow_snax_authors_to_add_referrals() {
	$default = snax_get_legacy_referrals_setting();

	return 'standard' === apply_filters( 'snax_video_allow_snax_authors_to_add_referrals', get_option( 'snax_video_allow_snax_authors_to_add_referrals', $default ) );
}
 ...
 * @return string
 */
function snax_video_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_video_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_video_singular_name', $val );
}
 ...
 * @return string
 */
function snax_video_get_add_new( $default = '' ) {
	$val = get_option( 'snax_video_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_video_add_new', $val );
}
 ...
 * @return string
 */
function snax_video_get_description( $default = '' ) {
	$val = get_option( 'snax_video_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_video_description', $val );
}
 ...
 * @return string
 */
function snax_video_get_overview( $default = '' ) {
	$val = get_option( 'snax_video_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_video_overview', $val );
}
