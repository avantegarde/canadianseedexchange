 ...
 * @return string
 */
function snax_meme_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_meme_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_meme_singular_name', $val );
}
 ...
 * @return string
 */
function snax_meme_get_add_new( $default = '' ) {
	$val = get_option( 'snax_meme_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_meme_add_new', $val );
}
 ...
 * @return string
 */
function snax_meme_get_description( $default = '' ) {
	$val = get_option( 'snax_meme_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_meme_description', $val );
}
 ...
 * @return string
 */
function snax_meme_get_overview( $default = '' ) {
	$val = get_option( 'snax_meme_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_meme_overview', $val );
}