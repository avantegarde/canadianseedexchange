...
function snax_admin_settings_fields_memes( $fields ) {
	$fields['snax_settings_memes'] = array(
		...
		'snax_meme_texts_header' => array(
			'title'             => '<h2>' . _x( 'Texts', 'Setting label', 'snax' ) . '</h2>',
			'callback'          => '__return_empty_string',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_meme_singular_name' => array(
			'title'             => _x( 'Singular name', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_meme_singular_name',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_meme_add_new' => array(
			'title'             => _x( 'Add new', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_meme_add_new',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_meme_description' => array(
			'title'             => _x( 'Description', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_meme_description',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_meme_overview' => array(
			'title'             => _x( 'Overview', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_meme_overview',
...
function snax_admin_memes_settings() {
	...
	<div class="wrap">
		...
		<?php snax_admin_settings_subtabs( 'formats', __( 'Memes', 'snax' ) ); ?>
 ...
 * Texts > Singular Name
 */
function snax_admin_setting_callback_meme_singular_name() {
	?>
	<input name="snax_meme_singular_name" id="snax_meme_singular_name" class="regular-text" type="text" value="<?php echo esc_attr( snax_meme_get_singular_name() ); ?>" placeholder="<?php echo esc_attr_x( 'e.g. Meme', 'Setting placeholder', 'snax' ); ?>" />
	<p class="description">
 ...
 * Texts > Add new
 */
function snax_admin_setting_callback_meme_add_new() {
	?>
	<input name="snax_meme_add_new" id="snax_meme_add_new" class="regular-text" type="text" value="<?php echo esc_attr( snax_meme_get_add_new() ); ?>" placeholder="<?php echo esc_attr_x( 'e.g. Create Your Meme', 'Setting placeholder', 'snax' ); ?>" />
	<p class="description">
		<?php echo esc_html_x( 'Leave empty to use default.', 'Setting description', 'snax' ); ?>
	</p>
	<?php
 ...
 * Texts > Description
 */
function snax_admin_setting_callback_meme_description() {
	?>
	<input name="snax_meme_description" id="snax_meme_description" class="regular-text" type="text" value="<?php echo esc_attr( snax_meme_get_description() ); ?>" placeholder="<?php echo esc_attr_x( 'e.g. Create a funny pic', 'Setting placeholder', 'snax' ); ?>" />
	<p class="description">
		<?php echo esc_html_x( 'Leave empty to use default.', 'Setting description', 'snax' ); ?>
	</p>
	<?php
 ...
 * Texts > Overview
 */
function snax_admin_setting_callback_meme_overview() {
	?>
	<textarea name="snax_meme_overview" id="snax_meme_overview" rows="5" class="large-text"><?php echo esc_attr( snax_meme_get_overview() ); ?></textarea>
	<?php
}
