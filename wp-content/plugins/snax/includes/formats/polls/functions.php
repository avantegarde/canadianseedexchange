 ...
 * Shortcut
 */
function snax_classic_poll_get_category_whitelist() {
	return snax_poll_get_category_whitelist();
}

/**
 * Shortcut
 */
function snax_binary_poll_get_category_whitelist() {
	return snax_poll_get_category_whitelist();
}
 ...
 * Shortcut
 */
function snax_versus_poll_get_category_whitelist() {
	return snax_poll_get_category_whitelist();
}
 ...
 * @return string
 */
function snax_classic_poll_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_classic_poll_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_classic_poll_singular_name', $val );
}
 ...
 * @return string
 */
function snax_classic_poll_get_add_new( $default = '' ) {
	$val = get_option( 'snax_classic_poll_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_classic_poll_add_new', $val );
}
 ...
 * @return string
 */
function snax_classic_poll_get_description( $default = '' ) {
	$val = get_option( 'snax_classic_poll_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_classic_poll_description', $val );
}
 ...
 * @return string
 */
function snax_classic_poll_get_overview( $default = '' ) {
	$val = get_option( 'snax_classic_poll_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_classic_poll_overview', $val );
}
 ...
 * @return string
 */
function snax_versus_poll_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_versus_poll_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_versus_poll_singular_name', $val );
}
 ...
 * @return string
 */
function snax_versus_poll_get_add_new( $default = '' ) {
	$val = get_option( 'snax_versus_poll_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_versus_poll_add_new', $val );
}
 ...
 * @return string
 */
function snax_versus_poll_get_description( $default = '' ) {
	$val = get_option( 'snax_versus_poll_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_versus_poll_description', $val );
}
 ...
 * @return string
 */
function snax_versus_poll_get_overview( $default = '' ) {
	$val = get_option( 'snax_versus_poll_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_versus_poll_overview', $val );
}
 ...
 * @return string
 */
function snax_binary_poll_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_binary_poll_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_binary_poll_singular_name', $val );
}
 ...
 * @return string
 */
function snax_binary_poll_get_add_new( $default = '' ) {
	$val = get_option( 'snax_binary_poll_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_binary_poll_add_new', $val );
}
 ...
 * @return string
 */
function snax_binary_poll_get_description( $default = '' ) {
	$val = get_option( 'snax_binary_poll_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_binary_poll_description', $val );
}
 ...
 * @return string
 */
function snax_binary_poll_get_overview( $default = '' ) {
	$val = get_option( 'snax_binary_poll_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_binary_poll_overview', $val );
}