 ...
 * @return string
 */
function snax_image_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_image_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_image_singular_name', $val );
}
 ...
 * @return string
 */
function snax_image_get_add_new( $default = '' ) {
	$val = get_option( 'snax_image_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_image_add_new', $val );
}
 ...
 * @return string
 */
function snax_image_get_description( $default = '' ) {
	$val = get_option( 'snax_image_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_image_description', $val );
}
 ...
 * @return string
 */
function snax_image_get_overview( $default = '' ) {
	$val = get_option( 'snax_image_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_image_overview', $val );
}