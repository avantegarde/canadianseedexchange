...
function snax_admin_settings_fields_links( $fields ) {
	$fields['snax_settings_links'] = array(
		...
		'snax_link_texts_header' => array(
			'title'             => '<h2>' . _x( 'Texts', 'Setting label', 'snax' ) . '</h2>',
			'callback'          => '__return_empty_string',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_link_singular_name' => array(
			'title'             => _x( 'Singular name', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_link_singular_name',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_link_add_new' => array(
			'title'             => _x( 'Add new', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_link_add_new',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_link_description' => array(
			'title'             => _x( 'Description', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_link_description',
			'sanitize_callback' => 'sanitize_text_field',
			'args'              => array(),
		),
		'snax_link_overview' => array(
			'title'             => _x( 'Overview', 'Setting label', 'snax' ),
			'callback'          => 'snax_admin_setting_callback_link_overview',
...
function snax_admin_links_settings() {
	...
	<div class="wrap">
		...
		<?php snax_admin_settings_subtabs( 'formats', __( 'Links', 'snax' ) ); ?>
 ...
 * Texts > Singular Name
 */
function snax_admin_setting_callback_link_singular_name() {
	?>
	<input name="snax_link_singular_name" id="snax_link_singular_name" class="regular-text" type="text" value="<?php echo esc_attr( snax_link_get_singular_name() ); ?>" placeholder="<?php echo esc_attr_x( 'e.g. Link', 'Setting placeholder', 'snax' ); ?>" />
	<p class="description">
 ...
 * Texts > Add new
 */
function snax_admin_setting_callback_link_add_new() {
	?>
	<input name="snax_link_add_new" id="snax_link_add_new" class="regular-text" type="text" value="<?php echo esc_attr( snax_link_get_add_new() ); ?>" placeholder="<?php echo esc_attr_x( 'e.g. Submit Your Link', 'Setting placeholder', 'snax' ); ?>" />
	<p class="description">
		<?php echo esc_html_x( 'Leave empty to use default.', 'Setting description', 'snax' ); ?>
	</p>
	<?php
 ...
 * Texts > Description
 */
function snax_admin_setting_callback_link_description() {
	?>
	<input name="snax_link_description" id="snax_link_description" class="regular-text" type="text" value="<?php echo esc_attr( snax_link_get_description() ); ?>" placeholder="<?php echo esc_attr_x( 'e.g. External site\'s link', 'Setting placeholder', 'snax' ); ?>" />
	<p class="description">
		<?php echo esc_html_x( 'Leave empty to use default.', 'Setting description', 'snax' ); ?>
	</p>
	<?php
 ...
 * Texts > Overview
 */
function snax_admin_setting_callback_link_overview() {
	?>
	<textarea name="snax_link_overview" id="snax_link_overview" rows="5" class="large-text" placeholder="<?php echo esc_attr_x( 'e.g. Just paste external site\'s URL, we will do the rest.', 'Setting placeholder', 'snax' ); ?>"><?php echo esc_attr( snax_link_get_overview() ); ?></textarea>
	<?php
}
