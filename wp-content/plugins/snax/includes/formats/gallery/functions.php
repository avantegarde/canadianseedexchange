 ...
 * @return string
 */
function snax_gallery_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_gallery_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_gallery_singular_name', $val );
}
 ...
 * @return string
 */
function snax_gallery_get_add_new( $default = '' ) {
	$val = get_option( 'snax_gallery_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_gallery_add_new', $val );
}
 ...
 * @return string
 */
function snax_gallery_get_description( $default = '' ) {
	$val = get_option( 'snax_gallery_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_gallery_description', $val );
}
 ...
 * @return string
 */
function snax_gallery_get_overview( $default = '' ) {
	$val = get_option( 'snax_gallery_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_gallery_overview', $val );
}
