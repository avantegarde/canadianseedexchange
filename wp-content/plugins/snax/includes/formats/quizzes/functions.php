 ...
 * Shortcut
 */
function snax_trivia_quiz_get_category_whitelist() {
	return snax_quiz_get_category_whitelist();
}

/**
 * Shortcut
 */
function snax_personality_quiz_get_category_whitelist() {
	return snax_quiz_get_category_whitelist();
}
 ...
 * @return string
 */
function snax_trivia_quiz_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_trivia_quiz_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_trivia_quiz_singular_name', $val );
}
 ...
 * @return string
 */
function snax_trivia_quiz_get_add_new( $default = '' ) {
	$val = get_option( 'snax_trivia_quiz_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_trivia_quiz_add_new', $val );
}
 ...
 * @return string
 */
function snax_trivia_quiz_get_description( $default = '' ) {
	$val = get_option( 'snax_trivia_quiz_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_trivia_quiz_description', $val );
}
 ...
 * @return string
 */
function snax_trivia_quiz_get_overview( $default = '' ) {
	$val = get_option( 'snax_trivia_quiz_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_trivia_quiz_overview', $val );
}
 ...
 * @return string
 */
function snax_personality_quiz_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_personality_quiz_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_personality_quiz_singular_name', $val );
}
 ...
 * @return string
 */
function snax_personality_quiz_get_add_new( $default = '' ) {
	$val = get_option( 'snax_personality_quiz_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_personality_quiz_add_new', $val );
}
 ...
 * @return string
 */
function snax_personality_quiz_get_description( $default = '' ) {
	$val = get_option( 'snax_personality_quiz_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_personality_quiz_description', $val );
}
 ...
 * @return string
 */
function snax_personality_quiz_get_overview( $default = '' ) {
	$val = get_option( 'snax_personality_quiz_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_personality_quiz_overview', $val );
}
