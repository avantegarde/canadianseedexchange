...
(function ($, ctx) {
    ...
    ctx.uploadExternalProduct = {};

    // Component namespace shortcut.
    var c = ctx.uploadExternalProduct;
    ...
    var selectors = {
        ...
        'form':                 '.snax-tab-content-extproduct',
    ...
    var i18n = {
        ...
        'processing_text':  ctx.config.i18n.extproduct_processing_text
    };
    ...
    c.attachEventHandlers = function($form) {
        ...
        $(selectors.feedbackWrapper).on('click', selectors.closeButton, function(e) {
            ...
            if ( stopProcessingForm ) {
                //Reset flag.
                stopProcessingForm = false;
                // Empty url.
                $form.find(selectors.linkUrlField).val('');
    ...
    c.fetchUrlData = function(url) {
        ...
        xhr.done(function (res) {
            ...
            if (res.status === 'success') {
                ...
                if ( res.args.stop_processing_form ) {
                    stopProcessingForm = true;
                }
            }
...
(function ($, ctx) {
    ...
    $(document).ready(function() {
        ctx.uploadExternalProduct.init();
    });
