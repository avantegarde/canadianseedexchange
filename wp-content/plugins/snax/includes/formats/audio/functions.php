 ...
 * @return string
 */
function snax_audio_get_singular_name( $default = '' ) {
	$val = get_option( 'snax_audio_singular_name' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_audio_singular_name', $val );
}
 ...
 * @return string
 */
function snax_audio_get_add_new( $default = '' ) {
	$val = get_option( 'snax_audio_add_new' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_audio_add_new', $val );
}
 ...
 * @return string
 */
function snax_audio_get_description( $default = '' ) {
	$val = get_option( 'snax_audio_description' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_audio_description', $val );
}
 ...
 * @return string
 */
function snax_audio_get_overview( $default = '' ) {
	$val = get_option( 'snax_audio_overview' );

	if ( empty( $val ) ) {
		$val = $default;
	}

	return apply_filters( 'snax_audio_overview', $val );
}
