...
if ( ! class_exists( 'Snax_Admin' ) ) :
	...
	final class Snax_Admin {
		...
		public function admin_menus() {
			...
			// Moderation.
			$hooks[] = add_options_page(
				__( 'Snax Moderation', 'snax' ),
				__( 'Snax Moderation', 'snax' ),
				$this->capability,
				'snax-moderation-settings',
				'snax_admin_moderation_settings'
			);
		...
		public function admin_head() {
			...
			remove_submenu_page( $this->settings_page, 'snax-moderation-settings' );
			...
			do_action( 'snax_hide_submenu_page', $this->settings_page );
		}
