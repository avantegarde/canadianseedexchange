...
if ( snax_can_use_plugin( 'wp-gdpr-compliance/wp-gdpr-compliance.php' ) ) {
	require_once( trailingslashit( plugin_dir_path( __FILE__ ) ) . '/wp-gdpr-compliance/wp-gdpr-compliance.php' );
}
