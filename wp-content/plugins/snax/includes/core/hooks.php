...
// HTTP Headers.
add_action( 'template_redirect', 'snax_modify_http_headers', 99 );
...
add_action( 'wp_ajax_snax_delete_post',         'snax_ajax_delete_post' );
...
add_action( 'snax_post_submission_count_updated',  'snax_close_post_submission', 10, 2 );
add_action( 'snax_post_approved',               'snax_post_items_update_status', 10, 1 );
add_filter( 'snax_entry_action_links_args',     'snax_add_post_report_link', 99 );

// Post comments.
add_action( 'snax_post_published', 'snax_post_allow_comments', 10, 2 );
...
add_action( 'wp_insert_post',               'snax_update_parent_submissions_count', 10, 1 );
add_action( 'trashed_post',                 'snax_trashed_item', 10, 1 );
add_action( 'untrashed_post',               'snax_untrashed_item', 10, 1 );
add_action( 'before_delete_post',           'snax_before_delete_item', 10, 1 );
add_action( 'deleted_post',                 'snax_deleted_item', 10, 1 );
add_action( 'snax_item_status_changed',     'snax_update_parent_submissions_count', 10, 1 );
...
add_action( 'snax_before_frontend_submission_form', 'snax_render_format_overview' );
...
add_filter( 'pre_get_posts',            'snax_allow_preview_pending_posts' );
...
add_action( 'delete_post',                      'snax_delete_post_votes', 10, 1 );
...
// Amazon.
add_filter( 'snax_page_metadata', 'snax_page_metadata_amazon', 10, 3 );
