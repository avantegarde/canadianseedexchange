		...
		<tr>
			...
			<td>
				<select id="snax_reveal_correct_wrong_answers" name="snax_reveal_correct_wrong_answers">
					<option value="standard"<?php selected( $snax_reveal_correct_wrong_answers, 'standard' ); ?>><?php esc_html_e( 'yes', 'snax' ); ?></option>
					<option value="none"<?php selected( $snax_reveal_correct_wrong_answers, 'none' ); ?>><?php esc_html_e( 'no', 'snax' ); ?></option>
				</select>
			</td>
		</tr>
