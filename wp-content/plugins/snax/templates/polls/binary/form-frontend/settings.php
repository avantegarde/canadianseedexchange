        ...
        <tr>
            ...
            <td>
                <select id="snax_allow_guests_to_play" name="snax_allow_guests_to_play">
                    <option value="standard"<?php selected( $snax_vote_limit, 'standard' ); ?>><?php esc_html_e( 'yes', 'snax' ); ?></option>
                    <option value="none"<?php selected( $snax_vote_limit, 'none' ); ?>><?php esc_html_e( 'no', 'snax' ); ?></option>
                </select>
            </td>
        </tr>
        <!-- Vote limit -->
        <tr>
            ...
            <td>
                <select id="snax_vote_limit" name="snax_vote_limit">
                    <option value="1"<?php selected( $snax_vote_limit, '1' ); ?>><?php esc_html_e( 'once', 'snax' ); ?></option>
                    <option value="-1"<?php selected( $snax_vote_limit, '-1' ); ?>><?php esc_html_e( 'no limits', 'snax' ); ?></option>
                </select>
            </td>
        </tr>
		<!-- Reveal results -->
