...
<div class="snax-quiz-result snax-quiz-result-unlocked">
	...
	<div class="snax-quiz-result-body">
		...
		<?php if ( snax_can_share_quiz() ): ?>
		<div class="snax-quiz-result-share">
			<h3 class="snax-quiz-result-share-title"><?php esc_html_e( 'Share your result', 'snax' ); ?></h3>

			<?php
			$snax_share_data = array(
				'title'       => $quiz_title,
				'description' => sprintf( __( 'I got %s', 'snax' ), get_the_title() ),
			);
