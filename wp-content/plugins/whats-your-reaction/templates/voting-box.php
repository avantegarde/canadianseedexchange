	...
	<div <?php wyr_render_reactions_body_class(); ?>>
		...
		<?php if ( wyr_can_use_plugin( 'buddypress/bp-loader.php' ) && bp_is_active( wyr_reactions_bp_component_id() ) && wyr_member_profile_link() ) : ?>
			<?php if ( is_user_logged_in() ) : ?>
				...
				<p class="wyr-reactions-footer"><?php echo wp_kses_post( sprintf( __( 'Browse and manage your reactions from your <a href="%s">Member Profile Page</a>', 'wyr' ), $bimber_url ) ); ?></p>
			<?php else : ?>
				<p class="wyr-reactions-footer"><?php echo wp_kses_post( __( 'Browse and manage your reactions from your Member Profile Page', 'wyr' ) ); ?></p>
			<?php endif; ?>
		<?php endif; ?>
	</div>
</aside>
